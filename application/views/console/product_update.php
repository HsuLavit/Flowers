		...
		<div class="ui grid">
			<div class="sixteen wide column">
				<h2 class="ui dividing header">
					...
					<div class="content">
						更新商品資訊
						<div class="sub header">可針對商品做更新</div>
					</div>
				</h2>
				...
				<form class="ui form tableForm" method="post" enctype="multipart/form-data">
					...
					<div class="ui grid">
						<div class="twelve wide column">
							...
							<div class="two fields">								
								...
								<label>商品標題 Title</label>
								<input type="text" name="title" value="<?=$res['title'];?>">
								</div>
								<div class="field">
								<label>商品分類 Category</label>
							...
							<h4 class="ui dividing header">商品說明 Content</h4>
							<div class="field">
						...
						<div class="four wide column">						
							<div class="ui padded segment main_photo_spec">
								<h4 class="ui dividing header">主要圖片 Main Photo</h4>
								<div class="field">
					...
					<a class="ui button" href="index.php/console/product/">取消</a>
				</form>
			</div>
		</div>
	</div>
...
<script>
	...
	function trumbowygContent() {
		$('#trumbowyg-content').trumbowyg({
			...
			plugins: {
				upload: {
					serverPath: 'index.php/api_console/upload_trumbowyg_image',
					fileFieldName: 'image',
					data: [],
	...
	function subPhotoButtonEvent() {
		...
		$('.sub_photo_file').change(function(e) {
			...
			var api = 'index.php/api_console/upload_sub_photo';
			$.ajax({
				url: api,
				type: 'POST',
				dataType: 'json',
	...
	function subPhotoRemove() {
		...
		$('.sub_photo_img').on('click', function() {
			...
			modal.modal({
				...
				onApprove: function() {
					var api = 'index.php/api_console/delete_sub_photo';
