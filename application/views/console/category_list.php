		...
		<div class="ui grid">
			<div class="sixteen wide column">
				<h2 class="ui dividing header">
					...
					<div class="content">
						商品分類設置
						<div class="sub header">可針對分類做新增 修改 刪除</div>
					</div>
				</h2>
				<div class="ui form tableform">
					<a href="index.php/console/category/insert" class="ui tiny blue button spBtn btnInsert">新增</a>
					<div class="field">
						<table class="ui celled padded table">
							...
							<tbody>
								...
								<tr class="center aligned">
									...
									<td><?=$value['type'];?></td>
									<td>
										<a href="index.php/console/category/update/<?=$value['id']?>" class="ui tiny green button spBtn">更新</a>
	...
	function remove() {
		$('.btnDelete').on('click', function(e) {
			...
			modal.modal({
				...
				onApprove: function() {
					var api = 'index.php/api_console/delete_category';
					$.post(api, {'id': id}, function(response) {
						window.alert(response.sys_msg);
						if(response.sys_code == 200) {
							location.href = 'index.php/console/category';
						}
					}, 'json');
				}
			}).modal('show');
