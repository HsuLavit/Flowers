		...
		<div class="ui grid">
			<div class="sixteen wide column">
				<h2 class="ui dividing header">
					...
					<div class="content">
						管理員設置
						<div class="sub header">可針對管理員做新增 修改 刪除</div>
					</div>
				</h2>
				<div class="ui form tableform">
					<a href="index.php/console/manager/insert" class="ui tiny blue button spBtn btnInsert">新增</a>
					<div class="field">
						<table class="ui celled padded table">
							...
							<tbody>
								...
								<tr class="center aligned">
									...
									<td><?=$value['email'];?></td>
									<td>
										<a href="index.php/console/manager/update/<?=$value['id']?>" class="ui tiny green button spBtn">更新</a>
